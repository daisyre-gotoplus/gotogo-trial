					...
					<?php
						if(count($hotel['hotels']) > 0){
							...
							foreach($hotel['roomtypes'] as $key => $value){
								...
								$roomtypes = ($roomtype_ctr == 0) ? "<td id='tdfourth' style='width:30%;' rowspan='".count($hotel['roomtypes'])."'><button type='button' class='btn btn-sm btn-primary' id='chkAvailabilityButton'>Check availability</button><div id='tblAnchorRooms'></div></td>" : "";
